            ...
            <div class="row w-100">
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  ...
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number"><?php echo $pedidosPendientes; ?></h3>
              ...
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  ...
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number">$<?php echo number_format($ingresosMensuales, 2); ?></h3>
              ...
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  ...
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number"><?php echo $totalProductos; ?></h3>
              ...
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  ...
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number"><?php echo $totalClientes; ?></h3>
              ...
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  <span class="panel-admin__stat-icon"><i class="fas fa-users"></i></span>
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number"><?php echo $pedidosCompletados; ?></h3>
              ...
              <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                <div class="panel-admin__stat-card w-100">
                  <span class="panel-admin__stat-icon"><i class="fas fa-dollar-sign"></i></span>
                  <div class="panel-admin__stat-info">
                    <h3 class="panel-admin__stat-number">$<?php echo number_format($ventasTotales, 2); ?></h3>
          ...
          <tbody>
            <?php foreach ($historialPedidos as $pedido): ?>
              <tr>
                ...
                <td>
                  <a href="detalles_pedido.php?id=<?php echo $pedido['id']; ?>" class="btn btn-sm btn-primary">Ver Detalles</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
